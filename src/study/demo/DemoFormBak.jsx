...
import { Layout,Form,Input,DatePicker,TimePicker,Switch,Checkbox,Radio,Button,Select } from 'element-react'
import RatInput from '@/components/form/src/field/RatInput'
export default class DemoFormBak extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
          <Form model={this.state.form} labelWidth="80" onSubmit={this.onSubmit.bind(this)}>
            <Form.Item label="活动名称">
              <RatInput modelForm={this.state.form} attr={{prop:'name'}} onChange={this.onChange.bind(this, 'name')} />
            </Form.Item>
